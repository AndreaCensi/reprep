...
from .constants import MIME_IMAGES
from .constants import MIME_WEB_IMAGES
...
class Figure(Node):
    ...
    def sub(self, resource, caption=None, display=None, **kwargs):
        ...
        if isinstance(resource, str):
            ...
            raise ValueError(
                "The first parameter to sub() must be either"
...
class SubFigure:
    def __init__(self, resource, image, web_image, caption: str):
        check_isinstance(caption, (type(None), str))
